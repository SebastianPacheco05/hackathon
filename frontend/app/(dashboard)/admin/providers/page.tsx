          ...
          {selectedProvider && (
            <div className="space-y-6 pt-2">
              ...
              <div>
                ...
                <span className={selectedProvider.ind_activo ? 'inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold bg-[#00B207] text-white' : 'inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold bg-red-600 text-white'}>

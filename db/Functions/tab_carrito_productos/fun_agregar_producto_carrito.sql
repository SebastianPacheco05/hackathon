 ...
 * Parámetros: id_combinacion_variante, cantidad, opciones_elegidas (opcional); precio y cant_stock desde product_variants.
...
DECLARE
    ...
    v_precio tab_combinaciones_variante_producto.precio%TYPE;
    v_stock tab_combinaciones_variante_producto.cant_stock%TYPE;
...
BEGIN
    ...
    SELECT precio, cant_stock INTO v_precio, v_stock
    FROM tab_combinaciones_variante_producto
    WHERE id_combinacion_variante = p_variant_id AND ind_activo = TRUE;
    ...
    INSERT INTO tab_carrito_productos (
        id_carrito, id_combinacion_variante, cantidad, precio_unitario_carrito, opciones_elegidas, usr_insert
    ) VALUES (
